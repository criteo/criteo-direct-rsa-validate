// Hash: RhflXJTx4K17AE1GLW+wgOS9qZJhBDh40fe9PQt1zEKZ7oeOFsHWDqhTv6hs/j9IDiMVfqzX1AF1PfGVZGhNVF15bAIkHPfc6mtxvVwX3qB95zVf8su8jcuMjzVXMOGoS0WvAiwIlTiZfHy5tsqR8gTqd3/dlGAHuI/vvV0R/xA=
(function () {
    'use strict';
    ...
    var DirectBiddingMetricBuilder = /** @class */ (function () {
        ...
        DirectBiddingMetricBuilder.prototype.addSlot = function (impId, zoneId, adUnitId) {
            var cachedBidUsed = this.cachedBidsReturned.filter(function (bid) { return bid.impid === adUnitId && bid.zoneid === zoneId; }).length > 0;
