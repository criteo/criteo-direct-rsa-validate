// Hash: BbssCU1WOfJ4NEC6WMQL0uBeTHO7vFw5c+wfI+BnfrajJW+DYXgCMoP+4DYjiYv7dRWtF+dO5qYwSXWqqH2PodK0GRarA70UleDKktrezzGmTOt5Bn1LQnoZA2lwoix86Ytm9MChZsaKUdE1zahoNy2HZjEnDrHhjlwtgXtLlmg=
(function () {
    'use strict';
    ...
    function getVendorConsentsCallback(vendorConsentsData, callback) {
        if (!vendorConsentsData) {
            ...
            callback({
                consentData: vendorConsentsData.metadata,
                consentGiven: vendorConsentsData.vendorConsents && vendorConsentsData.vendorConsents[CRITEO_VENDOR_ID.toString()] ? true : false,
                gdprApplies: vendorConsentsData.gdprApplies ? true : false
            });
        }
    }
    ...
    var Prebid = /** @class */ (function () {
        function Prebid(profileId, adapterVersion, bidRequests, bidderRequest) {
            ...
            if (bidderRequest.gdprConsent) {
                gdprConsent = {
                    gdprApplies: bidderRequest.gdprConsent.gdprApplies ? true : false,
                    consentGiven: bidderRequest.gdprConsent.vendorData && bidderRequest.gdprConsent.vendorData.vendorConsents &&
                        bidderRequest.gdprConsent.vendorData.vendorConsents[CRITEO_VENDOR_ID.toString(10)] ? true : false,
        ...
        Prebid.prototype.getBidRequestForSlot = function (slot) {
            for (var _i = 0, _a = this.bidRequests; _i < _a.length; _i++) {
                var request = _a[_i];
                if (request.adUnitCode === slot.impid && request.params.zoneId === slot.zoneid) {
                    return request;
                }
            }
            return undefined;
