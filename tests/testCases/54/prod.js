// Hash: f5dWV75bZ3T0QJ1mwo6/zfrYte0ao2VXkHdUR7Y8pwEbq82G93cq25yCDQZ1rbmNQFCU3z82s6AVsECoLnM8K/7UZRGXzh5o/O/RV/gFnmfbu8LywN4dyPyAKMBFQjJ1XBU9+UERMclVd433IDQp6xBG0cmMYuf57PVUvYrDuC4=
(function () {
    'use strict';
    ...
    var DirectBiddingCache = /** @class */ (function () {
        ...
        DirectBiddingCache.prototype.filterNoBidSlots = function (slots) {
            ...
            if (this.context.silentModeIgnored) {
                return slots;
            }
            return this.bidManager.filterNoBidSlots(slots);
        };
        DirectBiddingCache.prototype.silentModeEnabled = function () {
            return !this.context.silentModeIgnored && this.silentModeManager.silentModeEnabled();
        };
    ...
    var DirectBiddingMetric = /** @class */ (function () {
        function DirectBiddingMetric(impressionId, elapsed, isTimeout, pageLoadElapsed, adapterStartElapsed, cdbCallStartElapsed, cdbCallEndElapsed, setTargetingElapsed, adapterEndElapsed, adapterTimeout, adapterIsTimeout, zoneId, adUnitId, cachedBidUsed) {
            this.impressionId = impressionId;
    ...
    var DirectBiddingMetricBuilder = /** @class */ (function () {
        ...
        DirectBiddingMetricBuilder.prototype.build = function (impressionId) {
            ...
            var cachedBidUsed = this.cachedBidsReturned.filter(function (bid) { return bid.impid === _this.adUnitId && bid.zoneid === _this.zoneId; }).length > 0;
            return new DirectBiddingMetric(impressionId, this.elapsed, this.isTimeout, this.pageLoadElapsed, this.adapterStartElapsed, this.cdbCallStartElapsed, this.cdbCallEndElapsed, this.setTargetingElapsed, this.adapterEndElapsed, this.adapterTimeout, adapterIsTimeout, this.zoneId, this.adUnitId, cachedBidUsed);
        };
    ...
    var Prebid = /** @class */ (function () {
        function Prebid(profileId, adapterVersion, bidRequests, bidderRequest) {
            ...
            this.requestBuilder = new DirectBiddingRequestBuilder(this.cache.filterNoBidSlots(this.slots), window.criteo_pubtag.context, this.metricsManager, new DirectBiddingUrlBuilder(false), profileId, integrationMode, networkId, adapterVersion, gdprConsent);
    ...
    var Context = /** @class */ (function () {
        ...
        Context.prototype.shouldIgnoreSilentMode = function () {
