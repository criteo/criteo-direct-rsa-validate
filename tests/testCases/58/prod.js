// Hash: TbOnKZIhF2irawO81ZzR800t+HP7wN/5zSTB0S9p1PaQfQ0Nx8aeEwPOOiNLz0QmOVQaVBJS2L0Lmt+qKBBGbefteEmU/aR6MvW7bOZweqX6RN4LjijVd8kRZHIb5jqhXdhGeJ8juVIB6XsRb695hnHOGs5XT3LTZ689/wRwASc=
(function () {
    'use strict';
    ...
    var DirectBiddingMetric = /** @class */ (function () {
        function DirectBiddingMetric(slots, elapsed, isTimeout, pageLoadElapsed, adapterStartElapsed, cdbCallStartElapsed, cdbCallEndElapsed, setTargetingElapsed, adapterEndElapsed, adapterTimeout, adapterIsTimeout) {
            this.slots = slots;
    ...
    var DirectBiddingMetricBuilder = /** @class */ (function () {
        ...
        DirectBiddingMetricBuilder.prototype.build = function () {
            ...
            return new DirectBiddingMetric(this.slots, this.elapsed, this.isTimeout, this.pageLoadElapsed, this.adapterStartElapsed, this.cdbCallStartElapsed, this.cdbCallEndElapsed, this.setTargetingElapsed, this.adapterEndElapsed, this.adapterTimeout, adapterIsTimeout);
        };
    ...
    var CookieSynchronizer = /** @class */ (function () {
        ...
        CookieSynchronizer.prototype.synchronizeCriteoUid = function (forceSyncframe) {
            var _this = this;
            // Only drop syncframe on safari browsers and android browsers
            if (!forceSyncframe && !CookieSynchronizer.isSafariBrowser() && !CookieSynchronizer.isAndroidBrowser()) {
                return;
            }
