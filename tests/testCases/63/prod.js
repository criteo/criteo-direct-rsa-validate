// Hash: gsZFvhz1B45hZLPBbaxDpNIfpcWfvk5vzRgyJnj4PhLNEFw8TdzK+GcPGmmsZf+RzBF7LdTsQL2UD3ww1TGrDuLN8r8l9NxhyNLMrGLDwH66BwnDNF4Hdnt4+mI8AHfOLWiapxUY8V58IHTGjie3HdvADlk9pibewOic8xmSgRU=
(function () {
    'use strict';
    ...
    var DirectBiddingTimer = /** @class */ (function () {
        ...
        DirectBiddingTimer.prototype.finish = function (metricsManager, slots) {
            ...
            metricsManager.storeMetric(this.builder.build());
        };
    ...
    var Prebid = /** @class */ (function () {
        ...
        Prebid.prototype.handleBidWon = function (bid) {
            ...
            for (var _i = 0, metrics_1 = metrics; _i < metrics_1.length; _i++) {
                ...
                for (var _a = 0, _b = metric.slots; _a < _b.length; _a++) {
                    var slot = _b[_a];
