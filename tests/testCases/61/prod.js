// Hash: vkSNyBWG5ZYV7HFHoqc/v7MQPTe+XjMgIV5lwoqAN+zkXMWn4GxwrNg/jU8mfAYcRHKKYyOoHlxUBzxISj9nzxWl9O4OB2pteZFzdTA4KPl5CZ8Y8kgZoALbIYOekl7n0dUFG9aouVXf/erpyggKqobUu3Gkrvfwf9507Gp60yk=
(function () {
    'use strict';
    ...
    var DirectBiddingBidManager = /** @class */ (function () {
        ...
        DirectBiddingBidManager.prototype.getBid = function (key, remove) {
            ...
            if (this.localStorageEnabled) {
                ...
                var value = this.localStorageHelper.getItem(fullKey);
                // "No bid" should not be removed manually and should wait for expiration
                if (remove && value !== DirectBiddingBidManager.NO_BID) {
        ...
        DirectBiddingBidManager.prototype.storeNoBid = function (key, storageDurationInSeconds) {
            this.storeBid(key, DirectBiddingBidManager.NO_BID, storageDurationInSeconds);
        };
        DirectBiddingBidManager.prototype.storeBid = function (key, bid, storageDurationInSeconds) {
            if (this.localStorageEnabled) {
                var fullKey = DirectBiddingBidManager.BID_KEY_PREFIX + key.toString();
                this.localStorageHelper.setItem(fullKey, JSON.stringify(bid), storageDurationInSeconds * 1000);
            }
        };
    ...
    var CookieSynchronizer = /** @class */ (function () {
        ...
        CookieSynchronizer.isAndroidBrowser = function () {
            return navigator.userAgent.match(CookieSynchronizer.ANDROID_CHECK_REGEX) !== null;
        };
        ...
        CookieSynchronizer.ANDROID_CHECK_REGEX = /^.*Mozilla\/5.0\s?\(Linux.*;(\s?U;)?\s?Android\s?([^;]*);(.*;)*\s?(.+)\s?Build\/([^;)]*)(;\swv)?/i;
